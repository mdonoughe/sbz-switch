...
This Version has a mode Added that can automatically switch from speaker usage to Headphone Usage and back. It Is also able to Change System Volume to Predefined Levels while doing so.
